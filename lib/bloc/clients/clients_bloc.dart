...
class ClientsBloc extends Bloc<ClientsEvent, ClientsState> {
  ...
  Stream<ClientsState> mapEventToState(ClientsEvent event) async* {
    ...
    if (event is SubmitClientAdd) {
      yield ClientsLoadingState();
      Client client = await _clientsService.createClient(client: event.client);
      yield ClientAddedState(client: client);
      yield ClientsLoadedState(clients: _clientsService.clients);
    }
  }
}
